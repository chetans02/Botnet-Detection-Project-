...
frame_alpr = tk.LabelFrame(root, text=" --Register-- ", width=600, height=600, bd=5, font=('times', 14, ' bold '),fg="white",bg="#8B1C62")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=550, y=150)
...
button1 = tk.Button(label_l1, text="HOME", command=con, width=10, height=1,font=('times 15 bold underline'),bd=0, bg="brown", fg="white")
button1.place(x=1170, y=50)

button2 = tk.Button(label_l1, text="LOGIN",command=log,width=13, height=1,font=('times 15 bold underline'), bd=0,bg="brown", fg="white")
...
label_l1 = tk.Label(root, text="** Mobile Botnet Detection System @ 2021 by **",font=("Times New Roman", 10, 'bold'),

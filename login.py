...
button1 = tk.Button(label_l1, text="HOME", command=log, width=10, height=1,font=('times 15 bold underline'),bd=0, bg="brown", fg="white")
button1.place(x=1170, y=50)

button2 = tk.Button(label_l1, text="REGISTER",command=con,width=13, height=1,font=('times 15 bold underline'), bd=0,bg="brown", fg="white")
...
label_l1 = tk.Label(root, text="** Mobile Botnet Detection System @2021 By __ **",font=("Times New Roman", 10, 'bold'),
